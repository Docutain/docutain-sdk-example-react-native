  ...
  render() {
    return (
      ...
      <View style={{margin: 10}}>
        <ScrollView>
          <Input Label="Name1" Text={this.state.address.Name1}></Input>
          <Input Label="Name2" Text={this.state.address.Name2}></Input>
          <Input Label="Name3" Text={this.state.address.Name3}></Input>
          ...
          <Input Label="CustomerID" Text={this.state.address.CustomerId}></Input>
          ...
          <Input Label="InvoiceID" Text={this.state.dataObject.InvoiceId}></Input>
          <Input Label="Reference" Text={this.state.dataObject.Reference}></Input>
          <Input Label="PaymentState" Text={this.state.dataObject.PaymentState}></Input>
        </ScrollView>
      </View>
    );
  }
